...
if __name__ == "__main__":
    ...
    root_folder = "/home/martines/work/MG5_aMC_v3_1_1/PhD/DY/cms-dimuon-13TEV/recast"
    definitions = [
    ...
    # save file
    file_ = open("recast_dimuon.txt", "w")
    file_.write(mg5_script)
    file_.close()

    # launch mg5
    subprocess.Popen(["/bin/bash", "-i", "-c", "mg5 recast_dimuon.txt"])
